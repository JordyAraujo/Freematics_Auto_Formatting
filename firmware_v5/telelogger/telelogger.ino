...
{
  if(!obdCheck){ // Compara os PIDs disponíveis com a lista de PIDs selecionados, criando uma nova lista apenas com os que serão utilizados
    int listCount = 0;
